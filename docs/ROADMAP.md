...
## Phase 2: Trust Loop (June -- September 2026)
...
## Phase 3: Scale (September 2026 -- March 2027)
...
|-----------|--------|-------------|
| Demo v1 | April 15, 2026 | Working demo for Mozilla full proposal |
| v1.1 Trust Loop | June 2026 | Community verification, feed ingestion |
| v1.2 Subscriptions | September 2026 | Location-based alerts, notifications |
